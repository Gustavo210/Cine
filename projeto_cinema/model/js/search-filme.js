...
$(".input-search").on("input",function() {
    ...
    $.ajax({
        ...
        data.data.forEach(element => {
            $(".search-list").append('<div class="search-item"><img class="img-fluid" src="../model/img/sonic.jpg" style="height: 100px;"/><span class="title-search-filme position-absolute">'+element.Nome+' <span class="disc-search-filme">'+element.Descricao+'</span></span></div>');
        });
    });
});
