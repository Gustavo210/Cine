<%-- 
    Document   : rodape
    Created on : 22 de jun de 2020, 01:46:55
    Author     : gusta
--%>
...
<div  class="footer">
    ...
    <div class="row m-0 text-center pt-3 pb-3">
        <div class="col-sm row">
            ...
            <div class="col-sm-12">
                <img width="300px" src="img/app.png" alt="">
            </div>
        </div>
        <div class="col-sm row">
            <div class="col-sm-12">Siga-nos nas redes</div>
            <div class="col-sm-12">
                <img width="170px" src="img/social.svg" alt="Social">
            </div>
        </div>
        ...
        <div class="col-sm m-0 row">
            ...
            <div class="col-sm-12 pt-2">
                <img width="300px" src="img/pagamento.svg" alt="">
            </div>
        </div>
    </div>
</div>
